...
export const ToastProvider = ({ children }) => {
  ...
  const addToast = useCallback((title, msg = '', type = 'info', duration = 3500) => {
    const id = Date.now();
  ...
  const success = (t, m) => addToast(t, m, 'success');
  const error = (t, m) => addToast(t, m, 'error');
  const warning = (t, m) => addToast(t, m, 'warning');
  const info = (t, m) => addToast(t, m, 'info');
